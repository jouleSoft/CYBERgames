        ...
        <div class="core">
            ...
            <div id="main" style="padding-top: 25px">
				...
				<!--CUERPO DEL EDITOR DE ARTÍCULOS-->
				 <div id="formEditor">
					<form name="editor" id="editor" method="POST" autocomplete="on" action="preferencias.php">
						<!--ETIQUETAS DEL VISOR-->
						<div class="divFila" id="divUsername">
							...
							<div style="display: inline-block; margin-right: 15px; float: right">
								<label for="tipoVentana" id="tipoVentana">STD</label>
							</div>
						</div>
						...
						<div class="divFilaBotones" id="filaBotones">
							<input type="button" id="volverBtn" value="VOLVER" onclick="volver()" />
